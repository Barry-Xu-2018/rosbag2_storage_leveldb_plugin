...
#ifndef LEVELDB_STORAGE_HPP_
#define LEVELDB_STORAGE_HPP_
...
class ROSBAG2_STORAGE_PLUGINS_PUBLIC LeveldbStorage
...
public:
  ...
  void write(const vector_msgs_t & messages)
  override;
